...
<body <?php body_class() ?>>
    <header class="site-header">
        <div class="container">
            <h1 class="school-header-logo float-left">
                <a href="<?php echo site_url() ?>"><img src="<?php echo THEME_URI . '/images/mit-logo.png' ?>" alt="mit logo"></a>
            </h1>
            ...
            <div class="site-header__menu group">
                <nav class="main-navigation">
                    <ul>
                        ...
                        <li <?php if (is_page('about-us') or wp_get_post_parent_id(0) == 16) echo 'class="current-menu-item"' ?>><a href="<?php echo site_url('/about-us') ?>">About</a></li>
                        ...
                        <li <?php if (get_post_type() == 'post') echo 'class="current-menu-item"' ?>><a href="<?php echo site_url('/blog'); ?>">News</a></li>
                    </ul>
                </nav>
